...
void initHasp() {
    if (isMt4) {
        ...
        enableHook(hasp_login, 0x8921ED0);
        enableHook(hasp_get_size, 0x8922E60);
        enableHook(hasp_encrypt, 0x892205C);

        enableHook(hasp_logout, 0x89280F4);
        enableHook(hasp_decrypt, 0x8922148);
        enableHook(hasp_read, 0x8922CC8);
        enableHook(hasp_write, 0x8922D94);
